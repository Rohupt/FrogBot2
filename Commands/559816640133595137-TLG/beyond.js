...
module.exports = {
    authority: "everyone",
    botPermissions: [],
    data: new Discord.SlashCommandBuilder().setName(name).setDescription("Register DnDBeyond subscription")
        .addStringOption(o => o.setName("duration").setDescription("Duration of the subscription").setRequired(true)
            .addChoices(
    ...
    async execute(ia) {
        ...
        let messageToUser =
            ...
            `Any${
                ia.member.roles.cache.find((r) => r.id == "634967372976881664") ? " other " : " "
            } discounts will be informed to you by the subscription admins.`;
